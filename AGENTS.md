...
- The macOS 27 test host is Mac-M2 (see the machine-level memory notes); it sleeps after one idle minute, run `caffeinate` for long sessions.
...
| --- | --- | --- | --- |
| 1 | macOS 27 + Xcode 27 beta | iOS 27 | Verified (Mac-M2, iPhone 12 mini) |
| 2 | macOS 27 + Xcode 27 beta | iOS 27 / iOS 26 | Verified (Mac-M2, iPhone 15 Pro on 26.6.1; `touchscreenGesture` is iOS 27 only) |
