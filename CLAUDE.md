...
- Run device commands through `bin/ipb` and `scripts/smoke_matrix.sh`, never by hand-assembling helper invocations, so exit codes and logs stay comparable with the recorded verification runs.
